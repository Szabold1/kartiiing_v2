  ...
  return (
    <>
      ...
      <div className="hidden sm:flex fixed inset-0 w-full h-[100dvh] flex-col justify-center items-center bg-cover bg-center bg-fixed bg-[url('/images/hero-mobile.jpg')] lg:bg-[url('/images/hero.jpg')]">
        <div
          className="absolute inset-0 dark:bg-gradient-to-b dark:from-[rgba(25,25,25,0.8)] dark:to-[rgba(25,25,25,0.7)] bg-gradient-to-r from-[rgba(25,25,25,0.4)] to-[rgba(25,25,25,0.45)]"
          aria-hidden="true"
        ></div>
