...
export default function Hero({ subtitle }: Props) {
  ...
  return (
    <>
      ...
      <div
        className="hidden sm:flex fixed inset-0 w-full h-[100dvh] flex-col justify-center items-center bg-cover bg-center bg-fixed bg-[url('/images/hero-mobile.jpg')] lg:bg-[url('/images/hero.jpg')]"
        role="img"
        aria-label="Hero section with kart racing background"
      >
